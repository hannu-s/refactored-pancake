...
data_path = "D:/jyu/TIES4911 Deep-Learning for Cognitive Computing for devs/Task 5/rnn-data/"
...
train_data, valid_data, test_data, vocabulary, rev_dict = load_data()
train(train_data, vocabulary, 1, 1, 1, "test")